...
export default function ApiEmptyState({ onAdd }) {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-6 rounded-2xl border-2 border-dashed border-gray-200 bg-slate-50/60 px-8 py-16 text-center">
      ...
      <div className="flex flex-col gap-2 max-w-xs">
        <h3 className="text-base font-extrabold text-slate-700">No APIs added yet</h3>
        <p className="text-sm text-slate-400 leading-relaxed font-medium">
          Document your project's endpoints here. Add request bodies, response examples, and headers for your team.
        </p>
      </div>
