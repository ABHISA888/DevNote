  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-5">
      <div className="flex items-center justify-between mb-4">
        ...
        <button className="text-[9px] font-extrabold text-primary-600 hover:text-primary-700">
          Edit
        </button>
      </div>
      
      <div className="rounded-xl border border-primary-100 bg-primary-50/30 p-3 mb-4">
      ...
      <button className="w-full text-center text-[10px] font-bold text-slate-500 hover:text-primary-600 transition border border-dashed border-gray-200 rounded-lg py-2 hover:border-primary-200 hover:bg-primary-50/50">
        + Add Header Override
      </button>
    </div>
  );
