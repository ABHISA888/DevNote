  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm space-y-4">
      ...
      <div className="space-y-3.5">
        {deadlines.map((dl) => (
          <div key={dl.id} className="relative pl-3 border-l-2 border-indigo-500">
      ...
      <button className="w-full text-center text-[10px] font-bold text-indigo-600 hover:text-indigo-700 transition pt-1">
        View Full Timeline
      </button>
    </div>
  );
