  ...
  return (
    <div className="mb-6">
      ...
      <nav className="mb-1 flex items-center gap-1.5 text-xs font-semibold text-slate-400">
        ...
        <span className="hover:text-primary-600 cursor-pointer transition">DevLaunch Core</span>
      </nav>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
            ...
            <button className="flex items-center gap-1.5 bg-primary-600 px-3 py-2 text-xs font-semibold text-white">
              <List size={14} />
              List
            </button>
          </div>
          ...
          <button
            id="new-task-btn"
            onClick={onNewTask}
            className="flex items-center gap-2 rounded-lg bg-primary-600 px-4 py-2 text-xs font-bold text-white shadow-md shadow-primary-600/20 transition hover:bg-primary-700 active:scale-95"
          >
