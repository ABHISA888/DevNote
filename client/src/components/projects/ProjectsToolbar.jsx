  ...
  return (
    <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between mb-8">
      <div className="relative w-full max-w-sm">
        ...
        <input type="text" placeholder="Filter by name..." className="h-9 w-full rounded-lg border border-gray-200 bg-white pl-9 pr-4 text-xs font-semibold text-slate-700 placeholder-slate-400 outline-none transition focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 shadow-sm" />
      </div>
      <div className="flex flex-wrap items-center gap-3 xl:gap-6">
        ...
        <div className="flex items-center gap-4 border-l border-gray-200 pl-4 xl:pl-6">
          <div className="flex items-center rounded-lg border border-gray-200 bg-white p-0.5 shadow-sm">
            <button className="rounded-md bg-indigo-50 p-1.5 text-indigo-600 transition"><LayoutGrid size={14} /></button>
