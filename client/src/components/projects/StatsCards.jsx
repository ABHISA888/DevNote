  ...
  return (
    <div className="grid grid-cols-2 gap-4 md:grid-cols-5 mb-8">
      {PROJECT_STATS.map((stat) => {
        ...
        return (
          <div key={stat.id} className="flex flex-col justify-center rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition-all hover:border-primary-100 hover:shadow-md">
