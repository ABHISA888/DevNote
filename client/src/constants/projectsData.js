...
export const PROJECT_STATS = [
  ...
  { id: 'active', label: 'ACTIVE', value: '12', valueColor: 'text-indigo-600' },
  { id: 'completed', label: 'COMPLETED', value: '8' },
  { id: 'archived', label: 'ARCHIVED', value: '4' },
  { id: 'favorites', label: 'FAVORITES', value: '6', icon: Star, iconColor: 'text-indigo-600', fill: true },
];
...
export const RECENTLY_EDITED = [
  { id: 1, title: 'DevLaunch Core', time: '24 minutes ago', initials: 'DL', color: 'bg-indigo-100 text-indigo-700' },
...
export const STACK_OVERVIEW = [
  { id: 1, language: 'JavaScript/TS', percentage: 65, color: 'bg-indigo-600' },
...
export const ALL_PROJECTS = [
  {
    ...
    title: 'DevLaunch',
    initials: 'DL',
    initialsColor: 'bg-indigo-50 text-indigo-600 border-indigo-100',
